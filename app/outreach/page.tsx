...
const DEMO_PROSPECTS: OutreachProspect[] = [
  ...
  },
  {
    ...
    messages: [
      ...
      { step: 2, channel: 'email', day: 3, subject: 'Re: AI SDRs in healthtech', body: "Hi {{first_name}},\n\nFollowing up with something specific — healthtech companies like {{company}} use our AI SDR to handle the repetitive qualification conversations so their human team can focus on high-value deals.\n\nThe AI learns your ICP, qualification criteria, and even handles HIPAA-aware objections. It works 24/7 without adding headcount.\n\n15 minutes to walk through it?\n\nJamie", status: 'sent', sent_at: '2026-03-12T09:00:00Z', opened: true, clicked: true },
    ...
    <div style={{ minHeight: '100vh', background: c.bg, color: c.textPrimary }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, padding: '14px 24px', background: 'rgba(248,247,244,.85)', backdropFilter: 'blur(16px)', borderBottom: `1px solid ${c.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '5px', textDecoration: 'none', color: c.textPrimary }}>
            ...
            <span style={{ fontFamily: f.hd, fontSize: '16px', fontWeight: 900, letterSpacing: '-.03em' }}>amie<span style={{ color: '#C4B5FD', fontWeight: 500 }}>@</span>work</span>
          </Link>
