...
export default function SignUpPage() {
  ...
  const handleSignup = async () => {
    ...
    setLoading(false)
    router.push('/log-in?message=Check your email to confirm your account')
  }
      ...
      <div style={{ minHeight: '100vh', background: '#F8F7F4', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ width: '100%', maxWidth: '400px', position: 'relative', zIndex: 1 }}>
          ...
          <div className="r r1" style={{
            ...
            <p className="bd" style={{ fontSize: '14px', color: '#6B6B6B', marginBottom: '28px', fontWeight: 500, lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)}
                  placeholder="Jane Smith" autoFocus className="bd"
              ...
              <div>
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                  placeholder="you@company.com" className="bd"
                  style={{ width: '100%', padding: '11px 14px', borderRadius: '10px', border: '1.5px solid rgba(0,0,0,.1)', background: '#F8F7F4', color: '#1A1A1A', fontSize: '14px', fontWeight: 500, outline: 'none', transition: 'all .2s' }} />
              </div>
              ...
              <div>
                ...
                <input type="password" value={password} onChange={e => setPassword(e.target.value)}
                  placeholder="At least 6 characters" className="bd"
          ...
          <p className="r r2 bd" style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: '#6B6B6B', fontWeight: 500 }}>
            Already have an account?{' '}
            <Link href="/log-in" style={{ color: '#7C3AED', fontWeight: 700, textDecoration: 'none' }}>Log in</Link>
          </p>
          <p className="bd" style={{ textAlign: 'center', marginTop: '10px', fontSize: '12px' }}>
